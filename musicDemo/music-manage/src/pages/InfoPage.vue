    ...
    methods: {
        ...
        getSinger() {
            getAllSinger().then(response =>{
                ...
                this.singerSex.rows[0]['总数'] = this.setSex(1,response);
                this.singerSex.rows[1]['总数'] = this.setSex(0,response);
                this.singerSex.rows[2]['总数'] = this.setSex(2,response);
